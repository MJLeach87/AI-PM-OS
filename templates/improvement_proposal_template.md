...
**Quality Audit Reference**: `pm-os-reference/documentation/improvement_proposals/[audit-file].md`
...
**Proposal Location**: `pm-os-reference/documentation/improvement_proposals/YYYY-MM-DD_Proposal_[brief-title].md`
